...
<body>
	...
	<div style="text-align: left;" class="jumbotron container">
		<h2 style="text-align: center; color: blue;">Student's Registration Portal</h2>
		<form style="margin-left: 40%;">
			<input type="text" name="fname" placeholder="First name" required=""><br><br>
			<input type="text" name="2name" placeholder="Middle Name" required=""><br><br>
			<input type="text" name="3name" placeholder="Surname" required=""><br><br>
			...
			<button class="n btn-success" type="submit">Log in</button>
		</form>
	</div>
